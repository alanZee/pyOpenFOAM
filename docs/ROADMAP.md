...
**版本**: v2.0
**日期**: 2026-05-27
**目标**: 将 OpenFOAM v2512 的全部功能用 Python/PyTorch 无遗漏地重新实现
...
| 组件类别 | OpenFOAM 数量 | pyOpenFOAM 已有 | 缺口 |
|----------|-------------|----------------|------|
| 求解器物理 | 44 | 25 (2 个 stub) | 19 个新求解器 + 2 个修复 |
| 工具程序 | 134 | ~10 | ~124 个 |
| RANS 湍流模型 | 13 | 10 | 3 个 (LRR, SSG, kOmega2006) |
| LES 模型 | 6 | 5 | 1 个 (DeardorffDiffStress) |
| DES/DDES/IDDES | 4 | 2 | 2 个 (SA-DES, SA-IDDES) |
| 层流/粘弹性模型 | 6 | 0 | 6 个 |
| 广义牛顿粘度 | 7 | 0 | 7 个 |
...
### OpenFOAM v2512 官方资源
- **源码**: https://github.com/OpenFOAM/OpenFOAM-dev (Foundation) / https://develop.openfoam.com (ESI)
