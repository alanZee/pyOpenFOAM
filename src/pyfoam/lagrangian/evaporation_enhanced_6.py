"""
Enhanced evaporation models v6.

- :class:`SkinEvaporation` -- skin evaporation model
- :class:`HomogeneousEvaporation` -- homogeneous evaporation
"""
...
__all__ = ["SkinEvaporation", "HomogeneousEvaporation"]


class SkinEvaporation(EvaporationModel):
    """skin evaporation model."""
...
class HomogeneousEvaporation(EvaporationModel):
