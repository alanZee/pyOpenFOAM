"""
icoFoamEnhanced13 -- enhanced transient incompressible laminar solver v13.

Extends :class:`IcoFoamEnhanced12` with coupling algorithm variants.

Usage::

    from pyfoam.applications.ico_foam_enhanced_13 import IcoFoamEnhanced13

    solver = IcoFoamEnhanced13("path/to/case", simplec=True, coupled=True)
    solver.run()
"""
...
from .ico_foam_enhanced_12 import IcoFoamEnhanced12
from .time_loop import TimeLoop
from .convergence import ConvergenceMonitor

__all__ = ["IcoFoamEnhanced13"]

logger = logging.getLogger(__name__)


class IcoFoamEnhanced13(IcoFoamEnhanced12):
    """Enhanced transient incompressible laminar solver v13.
    ...
    def __init__(self, case_path: Union[str, Path], simplec: bool = True,
        ...
        logger.info("IcoFoamEnhanced13 ready: simplec=%s, coupled=%s", self.simplec, self.coupled)
    ...
    def run(self) -> ConvergenceData:
        ...
        logger.info("Starting icoFoamEnhanced13 run")
        ...
        for t, step in time_loop:
            ...
            if self.coupled:
                self.U, self.p = self._coupled_solve(self.U, self.p, current_dt)
