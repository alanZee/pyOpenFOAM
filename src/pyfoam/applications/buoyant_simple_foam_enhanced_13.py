"""
buoyantSimpleFoamEnhanced13 -- enhanced steady-state buoyant SIMPLE solver v13.

Extends :class:`BuoyantSimpleFoamEnhanced12` with coupling algorithm variants.

Usage::

    from pyfoam.applications.buoyant_simple_foam_enhanced_13 import BuoyantSimpleFoamEnhanced13

    solver = BuoyantSimpleFoamEnhanced13("path/to/case", simplec=True, coupled=True)
    solver.run()
"""
...
from .buoyant_simple_foam_enhanced_12 import BuoyantSimpleFoamEnhanced12
from .time_loop import TimeLoop
from .convergence import ConvergenceMonitor

__all__ = ["BuoyantSimpleFoamEnhanced13"]

logger = logging.getLogger(__name__)


class BuoyantSimpleFoamEnhanced13(BuoyantSimpleFoamEnhanced12):
    """Enhanced steady-state buoyant SIMPLE solver v13.
    ...
    def __init__(self, case_path: Union[str, Path], simplec: bool = True,
        ...
        logger.info("BuoyantSimpleFoamEnhanced13 ready: simplec=%s, coupled=%s", self.simplec, self.coupled)
    ...
    def run(self) -> ConvergenceData:
        ...
        logger.info("Starting buoyantSimpleFoamEnhanced13 run")
