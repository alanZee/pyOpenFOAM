...
from .spray_foam_enhanced_11 import SprayFoamEnhanced11
from .time_loop import TimeLoop
from .convergence import ConvergenceMonitor

__all__ = ["SprayFoamEnhanced12"]

logger = logging.getLogger(__name__)


class SprayFoamEnhanced12(SprayFoamEnhanced11):
    """Enhanced Lagrangian spray solver v12.
    ...
    def __init__(self, case_path: Union[str, Path], aur: bool = True,
        ...
        self._aur_alpha = 0.7
        logger.info("SprayFoamEnhanced12 ready: aur=%s, aitken=%s, fbur=%s",
    ...
    def run(self) -> dict:
        ...
        logger.info("Starting sprayFoamEnhanced12 run")
