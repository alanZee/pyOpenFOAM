"""
pisoFoamEnhanced13 -- enhanced transient incompressible PISO solver v13.

Extends :class:`PisoFoamEnhanced12` with coupling algorithm variants.

Usage::

    from pyfoam.applications.piso_foam_enhanced_13 import PisoFoamEnhanced13

    solver = PisoFoamEnhanced13("path/to/case", simplec=True, coupled=True)
    solver.run()
"""
...
from .piso_foam_enhanced_12 import PisoFoamEnhanced12
from .time_loop import TimeLoop
from .convergence import ConvergenceMonitor

__all__ = ["PisoFoamEnhanced13"]

logger = logging.getLogger(__name__)


class PisoFoamEnhanced13(PisoFoamEnhanced12):
    """Enhanced transient incompressible PISO solver v13.
    ...
    def __init__(self, case_path: Union[str, Path], simplec: bool = True,
        ...
        logger.info("PisoFoamEnhanced13 ready: simplec=%s, coupled=%s", self.simplec, self.coupled)
    ...
    def run(self) -> ConvergenceData:
        ...
        logger.info("Starting pisoFoamEnhanced13 run")
