"""Enhanced mapped flow rate boundary condition (v16).

In OpenFOAM syntax::

    type        mappedFlowRate16;
    value       uniform 0;
...
__all__ = ["MappedFlowRate16BC"]


@BoundaryCondition.register("mappedFlowRate16")
class MappedFlowRate16BC(BoundaryCondition):
    """Enhanced mapped flow rate v16.
    ...
    def apply(
        ...
        """Apply enhanced mapped flow rate v16."""
        device = field.device
        dtype = field.dtype
        ...
        # v16 enhancement: under-relaxation for stability.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v16 enhanced mapped flow rate BC."""
        device = get_device()
