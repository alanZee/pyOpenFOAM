"""Enhanced coupled temperature boundary condition (v8).

In OpenFOAM syntax::

    type        coupledTemperature8;
    value       uniform 0;

Coefficients:
    - Standard coupled temperature parameters (from base and earlier versions).
    - ``gradient_correct_coeff`` (float): Temperature gradient correction. (default 0.0).
"""
...
__all__ = ["CoupledTemperature8BC"]


@BoundaryCondition.register("coupledTemperature8")
class CoupledTemperature8BC(BoundaryCondition):
    """Enhanced coupled temperature v8.
    ...
    def apply(
        ...
        """Apply enhanced coupled temperature v8."""
        device = field.device
        dtype = field.dtype
        ...
        # v8 enhancement: temperature gradient correction.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v8 enhanced coupled temperature BC."""
        device = get_device()
