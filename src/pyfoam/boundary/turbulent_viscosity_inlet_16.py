"""Enhanced turbulent viscosity inlet boundary condition (v16).

In OpenFOAM syntax::

    type        turbulentViscosityInlet16;
    value       uniform 0;

Coefficients:
    - Standard turbulent viscosity inlet parameters (from base and earlier versions).
    - ``relax_nut_coeff`` (float): Nut under-relaxation. (default 0.5).
"""
...
__all__ = ["TurbulentViscosityInlet16BC"]


@BoundaryCondition.register("turbulentViscosityInlet16")
class TurbulentViscosityInlet16BC(BoundaryCondition):
    """Enhanced turbulent viscosity inlet v16.
    ...
    def __init__(self, patch: Patch, coeffs: dict[str, Any] | None = None) -> None:
        ...
        self._relax_nut_coeff = float(self._coeffs.get("relax_nut_coeff", 0.5))
    ...
    @property
    def relax_nut_coeff(self) -> float:
        return self._relax_nut_coeff
    def apply(
        self,
        field: torch.Tensor,
        patch_idx: int | None = None,
    ) -> torch.Tensor:
        """Apply enhanced turbulent viscosity inlet v16."""
        device = field.device
        dtype = field.dtype
        ...
        # v16 enhancement: nut under-relaxation.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v16 enhanced turbulent viscosity inlet BC."""
        device = get_device()
