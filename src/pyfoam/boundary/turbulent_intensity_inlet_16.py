"""Enhanced turbulent intensity inlet boundary condition (v16).

In OpenFOAM syntax::

    type        turbulentIntensityInlet16;
    value       uniform 0;
...
__all__ = ["TurbulentIntensityInlet16BC"]


@BoundaryCondition.register("turbulentIntensityInlet16")
class TurbulentIntensityInlet16BC(BoundaryCondition):
    """Enhanced turbulent intensity inlet v16.
    ...
    def apply(
        ...
        """Apply enhanced turbulent intensity inlet v16."""
        device = field.device
        dtype = field.dtype
    ...
    def matrix_contributions(
        ...
        """Penalty method for v16 enhanced turbulent intensity inlet BC."""
        device = get_device()
