"""Enhanced turbulent kinetic energy inlet boundary condition (v15).

In OpenFOAM syntax::

    type        turbulentKineticEnergyInlet15;
    value       uniform 0;

Coefficients:
    - Standard turbulent kinetic energy inlet parameters (from base and earlier versions).
    - ``temporal_relax_coeff`` (float): Temporal relaxation for stability. (default 0.5).
"""
...
__all__ = ["TurbulentKineticEnergyInlet15BC"]


@BoundaryCondition.register("turbulentKineticEnergyInlet15")
class TurbulentKineticEnergyInlet15BC(BoundaryCondition):
    """Enhanced turbulent kinetic energy inlet v15.
    ...
    def apply(
        ...
        """Apply enhanced turbulent kinetic energy inlet v15."""
        device = field.device
        dtype = field.dtype
        ...
        # v15 enhancement: temporal relaxation for stability.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v15 enhanced turbulent kinetic energy inlet BC."""
        device = get_device()
