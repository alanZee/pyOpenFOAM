"""Enhanced slip wall boundary condition (v8).
...
Coefficients:
    ...
    - ``curvature_coeff`` (float): Curvature-induced secondary flow correction. (default 0.0).
"""
...
@BoundaryCondition.register("slip8")
class Slip8BC(BoundaryCondition):
    """Enhanced slip wall v8.
    ...
    def apply(
        ...
        # v8 enhancement: curvature-induced secondary flow correction.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v8 enhanced slip wall BC."""
        device = get_device()
