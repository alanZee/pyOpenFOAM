"""Enhanced phase mean velocity boundary condition (v6).

In OpenFOAM syntax::

    type        phaseMeanVelocity6;
    value       uniform 0;

Coefficients:
    - Standard phase mean velocity parameters (from base and earlier versions).
    - ``wall_correction_coeff`` (float): Wall proximity correction. (default 0.0).
"""
...
__all__ = ["PhaseMeanVelocity6BC"]


@BoundaryCondition.register("phaseMeanVelocity6")
class PhaseMeanVelocity6BC(BoundaryCondition):
    """Enhanced phase mean velocity v6.
    ...
    def apply(
        ...
        """Apply enhanced phase mean velocity v6."""
        device = field.device
        dtype = field.dtype
        ...
        # v6 enhancement: wall proximity correction.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v6 enhanced phase mean velocity BC."""
        device = get_device()
