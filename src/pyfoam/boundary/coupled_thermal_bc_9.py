"""Enhanced coupled temperature boundary condition (v9).

In OpenFOAM syntax::

    type        coupledTemperature9;
    value       uniform 0;

Coefficients:
    - Standard coupled temperature parameters (from base and earlier versions).
    - ``spatial_smooth_coeff`` (float): Spatial smoothing. (default 0.0).
"""
...
__all__ = ["CoupledTemperature9BC"]


@BoundaryCondition.register("coupledTemperature9")
class CoupledTemperature9BC(BoundaryCondition):
    """Enhanced coupled temperature v9.
    ...
    def apply(
        ...
        """Apply enhanced coupled temperature v9."""
        device = field.device
        dtype = field.dtype
        ...
        # v9 enhancement: spatial smoothing.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v9 enhanced coupled temperature BC."""
        device = get_device()
