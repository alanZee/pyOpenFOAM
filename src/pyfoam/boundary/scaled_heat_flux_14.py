"""Enhanced scaled heat flux boundary condition (v14).

In OpenFOAM syntax::

    type        scaledHeatFlux14;
    value       uniform 0;

Coefficients:
    - Standard scaled heat flux parameters (from base and earlier versions).
    - ``volumetric_coeff`` (float): Volumetric heat generation correction. (default 0.0).
"""
...
__all__ = ["ScaledHeatFlux14BC"]


@BoundaryCondition.register("scaledHeatFlux14")
class ScaledHeatFlux14BC(BoundaryCondition):
    """Enhanced scaled heat flux v14.
    ...
    def apply(
        ...
        """Apply enhanced scaled heat flux v14."""
        device = field.device
        dtype = field.dtype
        ...
        # v14 enhancement: volumetric heat generation correction.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v14 enhanced scaled heat flux BC."""
        device = get_device()
