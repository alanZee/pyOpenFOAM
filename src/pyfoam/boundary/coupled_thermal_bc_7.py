"""Enhanced coupled temperature boundary condition (v7).

In OpenFOAM syntax::

    type        coupledTemperature7;
    value       uniform 0;

Coefficients:
    - Standard coupled temperature parameters (from base and earlier versions).
    - ``thermal_inertia_coeff`` (float): Thermal inertia at interface. (default 0.0).
"""
...
__all__ = ["CoupledTemperature7BC"]


@BoundaryCondition.register("coupledTemperature7")
class CoupledTemperature7BC(BoundaryCondition):
    """Enhanced coupled temperature v7.
    ...
    def apply(
        ...
        """Apply enhanced coupled temperature v7."""
        device = field.device
        dtype = field.dtype
        ...
        # v7 enhancement: thermal inertia at interface.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v7 enhanced coupled temperature BC."""
        device = get_device()
