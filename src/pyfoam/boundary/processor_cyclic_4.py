"""Enhanced processor cyclic boundary condition (v4).

In OpenFOAM syntax::

    type        processorCyclic4;
    value       uniform 0;

Coefficients:
    - Standard processor cyclic parameters (from base and earlier versions).
    - ``face_reorder_coeff`` (float): Face reordering correction. (default 0.0).
"""
...
__all__ = ["ProcessorCyclic4BC"]


@BoundaryCondition.register("processorCyclic4")
class ProcessorCyclic4BC(BoundaryCondition):
    """Enhanced processor cyclic v4.
    ...
    def apply(
        ...
        """Apply enhanced processor cyclic v4."""
        device = field.device
        dtype = field.dtype
        ...
        # v4 enhancement: face reordering correction.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v4 enhanced processor cyclic BC."""
        device = get_device()
