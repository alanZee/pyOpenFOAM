"""Enhanced slip wall boundary condition (v6).
...
Coefficients:
    ...
    - ``pressure_gradient_coeff`` (float): Pressure-gradient slip correction. (default 0.0).
"""
...
@BoundaryCondition.register("slip6")
class Slip6BC(BoundaryCondition):
    """Enhanced slip wall v6.
    ...
    def apply(
        ...
        # v6 enhancement: pressure-gradient slip correction.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v6 enhanced slip wall BC."""
        device = get_device()
