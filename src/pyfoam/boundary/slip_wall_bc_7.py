"""Enhanced slip wall boundary condition (v7).
...
Coefficients:
    ...
    - ``turbulence_damp_coeff`` (float): Turbulence damping at slip wall. (default 0.0).
"""
...
@BoundaryCondition.register("slip7")
class Slip7BC(BoundaryCondition):
    """Enhanced slip wall v7.
    ...
    def apply(
        ...
        # v7 enhancement: turbulence damping at slip wall.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v7 enhanced slip wall BC."""
        device = get_device()
