"""Enhanced slip wall boundary condition (v5).
...
Coefficients:
    ...
    - ``roughness_coeff`` (float): Roughness-induced slip correction. (default 0.0).
"""
...
@BoundaryCondition.register("slip5")
class Slip5BC(BoundaryCondition):
    """Enhanced slip wall v5.
    ...
    def apply(
        ...
        # v5 enhancement: roughness-induced slip correction.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v5 enhanced slip wall BC."""
        device = get_device()
