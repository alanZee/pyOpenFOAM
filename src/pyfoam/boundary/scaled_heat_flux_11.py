"""Enhanced scaled heat flux boundary condition (v11).

In OpenFOAM syntax::

    type        scaledHeatFlux11;
    value       uniform 0;

Coefficients:
    - Standard scaled heat flux parameters (from base and earlier versions).
    - ``beta_eps`` (float): Temperature-dependent emissivity. (default 0.0).
"""
...
__all__ = ["ScaledHeatFlux11BC"]


@BoundaryCondition.register("scaledHeatFlux11")
class ScaledHeatFlux11BC(BoundaryCondition):
    """Enhanced scaled heat flux v11.
    ...
    def apply(
        ...
        """Apply enhanced scaled heat flux v11."""
        device = field.device
        dtype = field.dtype
        ...
        # v11 enhancement: temperature-dependent emissivity.
        T_ref = 300.0
    ...
    def matrix_contributions(
        ...
        """Penalty method for v11 enhanced scaled heat flux BC."""
        device = get_device()
