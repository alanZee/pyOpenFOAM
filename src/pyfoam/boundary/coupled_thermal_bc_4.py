"""Enhanced coupled temperature boundary condition (v4).

In OpenFOAM syntax::

    type        coupledTemperature4;
    value       uniform 0;

Coefficients:
    - Standard coupled temperature parameters (from base and earlier versions).
    - ``interfacial_htc`` (float): Interfacial heat transfer correction. (default 0.0).
"""
...
__all__ = ["CoupledTemperature4BC"]


@BoundaryCondition.register("coupledTemperature4")
class CoupledTemperature4BC(BoundaryCondition):
    """Enhanced coupled temperature v4.
    ...
    def apply(
        ...
        """Apply enhanced coupled temperature v4."""
        device = field.device
        dtype = field.dtype
        ...
        # v4 enhancement: interfacial heat transfer correction.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v4 enhanced coupled temperature BC."""
        device = get_device()
