"""Enhanced slip wall boundary condition (v10).
...
Coefficients:
    ...
    - ``relax_coeff`` (float): Under-relaxation for slip wall stability. (default 1.0).
"""
...
@BoundaryCondition.register("slip10")
class Slip10BC(BoundaryCondition):
    """Enhanced slip wall v10.
    ...
    def apply(
        ...
        # v10 enhancement: under-relaxation for slip wall stability.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v10 enhanced slip wall BC."""
        device = get_device()
