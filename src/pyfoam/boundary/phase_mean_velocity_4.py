"""Enhanced phase mean velocity boundary condition (v4).

In OpenFOAM syntax::

    type        phaseMeanVelocity4;
    value       uniform 0;

Coefficients:
    - Standard phase mean velocity parameters (from base and earlier versions).
    - ``pressure_coupling_coeff`` (float): Phase-pressure coupling. (default 0.02).
"""
...
__all__ = ["PhaseMeanVelocity4BC"]


@BoundaryCondition.register("phaseMeanVelocity4")
class PhaseMeanVelocity4BC(BoundaryCondition):
    """Enhanced phase mean velocity v4.
    ...
    def apply(
        ...
        """Apply enhanced phase mean velocity v4."""
        device = field.device
        dtype = field.dtype
        ...
        # v4 enhancement: phase-pressure coupling.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v4 enhanced phase mean velocity BC."""
        device = get_device()
