"""Enhanced processor cyclic boundary condition (v5).

In OpenFOAM syntax::

    type        processorCyclic5;
    value       uniform 0;

Coefficients:
    - Standard processor cyclic parameters (from base and earlier versions).
    - ``ghost_cell_coeff`` (float): Ghost cell extrapolation. (default 0.1).
"""
...
__all__ = ["ProcessorCyclic5BC"]


@BoundaryCondition.register("processorCyclic5")
class ProcessorCyclic5BC(BoundaryCondition):
    """Enhanced processor cyclic v5.
    ...
    def apply(
        ...
        """Apply enhanced processor cyclic v5."""
        device = field.device
        dtype = field.dtype
        ...
        # v5 enhancement: ghost cell extrapolation.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v5 enhanced processor cyclic BC."""
        device = get_device()
