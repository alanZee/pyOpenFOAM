"""Enhanced wedge boundary condition (v8).
...
Coefficients:
    ...
    - ``viscous_correction_coeff`` (float): Viscous correction (informational). (default 0.0).
"""
...
@BoundaryCondition.register("wedge8")
class Wedge8BC(BoundaryCondition):
    """Enhanced wedge v8.
    ...
    def apply(
        ...
        # v8 enhancement: viscous correction (informational).
        pass
    ...
    def matrix_contributions(
        ...
        """Penalty method for v8 enhanced wedge BC."""
        device = get_device()
