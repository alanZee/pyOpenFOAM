"""Enhanced wedge boundary condition (v4).
...
Coefficients:
    ...
    - ``radial_correction_coeff`` (float): Radial correction (informational). (default 0.0).
"""
...
@BoundaryCondition.register("wedge4")
class Wedge4BC(BoundaryCondition):
    """Enhanced wedge v4.
    ...
    def apply(
        ...
        # v4 enhancement: radial correction (informational).
        pass
    ...
    def matrix_contributions(
        ...
        """Penalty method for v4 enhanced wedge BC."""
        device = get_device()
