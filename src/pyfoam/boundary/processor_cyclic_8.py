"""Enhanced processor cyclic boundary condition (v8).

In OpenFOAM syntax::

    type        processorCyclic8;
    value       uniform 0;

Coefficients:
    - Standard processor cyclic parameters (from base and earlier versions).
    - ``gradient_correct_coeff`` (float): Gradient correction at interface. (default 0.02).
"""
...
__all__ = ["ProcessorCyclic8BC"]


@BoundaryCondition.register("processorCyclic8")
class ProcessorCyclic8BC(BoundaryCondition):
    """Enhanced processor cyclic v8.
    ...
    def apply(
        ...
        """Apply enhanced processor cyclic v8."""
        device = field.device
        dtype = field.dtype
        ...
        # v8 enhancement: gradient correction at interface.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v8 enhanced processor cyclic BC."""
        device = get_device()
