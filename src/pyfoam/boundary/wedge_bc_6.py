"""Enhanced wedge boundary condition (v6).
...
Coefficients:
    ...
    - ``normal_correction_coeff`` (float): Normal correction (informational). (default 0.0).
"""
...
@BoundaryCondition.register("wedge6")
class Wedge6BC(BoundaryCondition):
    """Enhanced wedge v6.
    ...
    def apply(
        ...
        # v6 enhancement: normal correction (informational).
        pass
    ...
    def matrix_contributions(
        ...
        """Penalty method for v6 enhanced wedge BC."""
        device = get_device()
