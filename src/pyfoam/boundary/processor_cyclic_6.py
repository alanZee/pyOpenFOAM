"""Enhanced processor cyclic boundary condition (v6).

In OpenFOAM syntax::

    type        processorCyclic6;
    value       uniform 0;
...
__all__ = ["ProcessorCyclic6BC"]


@BoundaryCondition.register("processorCyclic6")
class ProcessorCyclic6BC(BoundaryCondition):
    """Enhanced processor cyclic v6.
    ...
    def apply(
        ...
        """Apply enhanced processor cyclic v6."""
        device = field.device
        dtype = field.dtype
        ...
        # v6 enhancement: conservation correction.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v6 enhanced processor cyclic BC."""
        device = get_device()
