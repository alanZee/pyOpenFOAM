"""Enhanced outlet phase mean velocity boundary condition (v11).

In OpenFOAM syntax::

    type        outletPhaseMeanVelocity11;
    value       uniform 0;
...
__all__ = ["OutletPhaseMeanVelocity11BC"]


@BoundaryCondition.register("outletPhaseMeanVelocity11")
class OutletPhaseMeanVelocity11BC(BoundaryCondition):
    """Enhanced outlet phase mean velocity v11.
    ...
    def apply(
        ...
        """Apply enhanced outlet phase mean velocity v11."""
        device = field.device
        dtype = field.dtype
        ...
        # v11 enhancement: entropy generation correction.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v11 enhanced outlet phase mean velocity BC."""
        device = get_device()
