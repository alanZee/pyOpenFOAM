"""Enhanced phase mean velocity boundary condition (v9).

In OpenFOAM syntax::

    type        phaseMeanVelocity9;
    value       uniform 0;

Coefficients:
    - Standard phase mean velocity parameters (from base and earlier versions).
    - ``lift_coeff`` (float): Lift force correction. (default 0.0).
"""
...
__all__ = ["PhaseMeanVelocity9BC"]


@BoundaryCondition.register("phaseMeanVelocity9")
class PhaseMeanVelocity9BC(BoundaryCondition):
    """Enhanced phase mean velocity v9.
    ...
    def apply(
        ...
        """Apply enhanced phase mean velocity v9."""
        device = field.device
        dtype = field.dtype
        ...
        # v9 enhancement: lift force correction.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v9 enhanced phase mean velocity BC."""
        device = get_device()
