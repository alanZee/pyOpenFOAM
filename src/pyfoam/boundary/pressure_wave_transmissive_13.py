"""Enhanced wave transmissive boundary condition (v13).

In OpenFOAM syntax::

    type        pressureWaveTransmissive13;
    value       uniform 0;

Coefficients:
    - Standard wave transmissive parameters (from base and earlier versions).
    - ``entropy_wave_coeff`` (float): Entropy wave correction. (default 0.01).
"""
...
__all__ = ["PressureWaveTransmissive13BC"]


@BoundaryCondition.register("pressureWaveTransmissive13")
class PressureWaveTransmissive13BC(BoundaryCondition):
    """Enhanced wave transmissive v13.
    ...
    def apply(
        ...
        """Apply enhanced wave transmissive v13."""
        device = field.device
        dtype = field.dtype
        ...
        # v13 enhancement: entropy wave correction.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v13 enhanced wave transmissive BC."""
        device = get_device()
