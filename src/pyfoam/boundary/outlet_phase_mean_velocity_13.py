"""Enhanced outlet phase mean velocity boundary condition (v13).

In OpenFOAM syntax::

    type        outletPhaseMeanVelocity13;
    value       uniform 0;

Coefficients:
    - Standard outlet phase mean velocity parameters (from base and earlier versions).
    - ``vorticity_damp_coeff`` (float): Vorticity damping at outlet. (default 0.04).
"""
...
__all__ = ["OutletPhaseMeanVelocity13BC"]


@BoundaryCondition.register("outletPhaseMeanVelocity13")
class OutletPhaseMeanVelocity13BC(BoundaryCondition):
    """Enhanced outlet phase mean velocity v13.
    ...
    def apply(
        ...
        """Apply enhanced outlet phase mean velocity v13."""
        device = field.device
        dtype = field.dtype
        ...
        # v13 enhancement: vorticity damping at outlet.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v13 enhanced outlet phase mean velocity BC."""
        device = get_device()
