"""Enhanced wave transmissive boundary condition (v14).

In OpenFOAM syntax::

    type        pressureWaveTransmissive14;
    value       uniform 0;

Coefficients:
    - Standard wave transmissive parameters (from base and earlier versions).
    - ``turb_damp_coeff`` (float): Turbulent pressure damping. (default 0.03).
"""
...
__all__ = ["PressureWaveTransmissive14BC"]


@BoundaryCondition.register("pressureWaveTransmissive14")
class PressureWaveTransmissive14BC(BoundaryCondition):
    """Enhanced wave transmissive v14.
    ...
    def apply(
        ...
        """Apply enhanced wave transmissive v14."""
        device = field.device
        dtype = field.dtype
        ...
        # v14 enhancement: turbulent pressure damping.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v14 enhanced wave transmissive BC."""
        device = get_device()
