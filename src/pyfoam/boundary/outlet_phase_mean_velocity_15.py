"""Enhanced outlet phase mean velocity boundary condition (v15).

In OpenFOAM syntax::

    type        outletPhaseMeanVelocity15;
    value       uniform 0;

Coefficients:
    - Standard outlet phase mean velocity parameters (from base and earlier versions).
    - ``non_reflect_coeff`` (float): Non-reflecting outlet correction. (default 0.1).
"""
...
__all__ = ["OutletPhaseMeanVelocity15BC"]


@BoundaryCondition.register("outletPhaseMeanVelocity15")
class OutletPhaseMeanVelocity15BC(BoundaryCondition):
    """Enhanced outlet phase mean velocity v15.
    ...
    def apply(
        ...
        """Apply enhanced outlet phase mean velocity v15."""
        device = field.device
        dtype = field.dtype
        ...
        # v15 enhancement: non-reflecting outlet correction.
    ...
    def matrix_contributions(
        ...
        """Penalty method for v15 enhanced outlet phase mean velocity BC."""
        device = get_device()
