"""Enhanced wedge boundary condition (v10).
...
Coefficients:
    ...
    - ``full_correction_coeff`` (float): Multi-physics correction (informational). (default 0.0).
"""
...
@BoundaryCondition.register("wedge10")
class Wedge10BC(BoundaryCondition):
    """Enhanced wedge v10.
    ...
    def __init__(self, patch: Patch, coeffs: dict[str, Any] | None = None) -> None:
        ...
        self._full_correction_coeff = float(self._coeffs.get("full_correction_coeff", 0.0))
    ...
    @property
    def full_correction_coeff(self) -> float:
        return self._full_correction_coeff
    def apply(
        self,
        field: torch.Tensor,
        patch_idx: int | None = None,
    ) -> torch.Tensor:
        """Apply enhanced wedge v10."""
        device = field.device
        dtype = field.dtype
        ...
        # v10 enhancement: multi-physics correction (informational).
        pass
    ...
    def matrix_contributions(
        ...
        """Penalty method for v10 enhanced wedge BC."""
        device = get_device()
