...
| MagneticFoam | B | 122608766242755.8 | — | ✅ 真实物理 |
...
1. **OpenFOAM-13 参照对比**: Docker Desktop WSL2 后端故障，源码编译需 GCC 11+（当前 GCC 9.4）
2. **可微分求解器**: 4x4/8x8/16x16 梯度均有限，更大网格待验证
3. **CavitatingFoam**: 速度限制器 100 m/s，空化模型需进一步调参
