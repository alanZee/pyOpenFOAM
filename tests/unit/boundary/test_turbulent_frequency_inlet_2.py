"""Tests for enhanced turbulent frequency inlet boundary condition (v2)."""
...
class TestTurbulentFrequencyInlet2BC:
    """Test the turbulentFrequencyInlet2 boundary condition."""
    ...
    def test_factory_creation(self, simple_patch):
        bc = BoundaryCondition.create(
            "turbulentFrequencyInlet2", simple_patch,
    ...
    def test_apply_with_velocity(self, simple_patch):
        """omega = k^0.5 / (C_mu^0.25 * l_mix) from intensity."""
        bc = TurbulentFrequencyInlet2BC(simple_patch, {
    ...
    def test_apply_with_k(self, simple_patch):
        bc = TurbulentFrequencyInlet2BC(simple_patch, {"lengthScale": 0.02})
