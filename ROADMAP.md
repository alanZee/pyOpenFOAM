...
| OpenFOAM 参照对比 | **257 算例已生成 (96% v13 教程覆盖)** | 267 算例 | ⚠️ |
| **教程求解器覆盖** | **240/240 (100%)** | 240/240 | **✅** |
| Cavity 20x20 精度 | 0.9% 误差 (vs Ghia) | <5% | ✅ |
| Cavity 32x32 精度 | 1.0% 误差 | <5% | ✅ |
| Cavity Re=400 | 128x128: 9.9e-03 连续性 (5000 iter, 23.8h) | <5% | ⚠️ |
...
**任务清单**:
- [x] E1. 验证 32x32+ 可微分梯度精度 — 36 单元测试通过
- [x] E2. 形状优化端到端测试 — DifferentiableSIMPLE 可用
- [x] E3. 可微分 SIMPLE/PISO 验证 — 42 可微分测试通过
