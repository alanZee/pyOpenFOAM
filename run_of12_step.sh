#!/bin/bash
# Run backward-facing step reference with OpenFOAM v12
...
echo "=== Backward-Facing Step Reference (OpenFOAM v12) ==="
CASE_DIR=/tmp/step_v12
rm -rf $CASE_DIR
mkdir -p $CASE_DIR/0 $CASE_DIR/constant/polyMesh $CASE_DIR/system

# Simple step geometry: inlet channel -> step -> expanded channel
cat > $CASE_DIR/system/blockMeshDict << 'EOF'
FoamFile { version 2.0; format ascii; class dictionary; object blockMeshDict; }
scale 1;
vertices (
    (0 0 0) (5 0 0) (5 1 0) (0 1 0)
    (0 0 0.1) (5 0 0.1) (5 1 0.1) (0 1 0.1)
);
blocks (hex (0 1 2 3 4 5 6 7) (50 10 1) simpleGrading (1 1 1));
edges ();
boundary (
...
if m:
    ...
    if ux:
        print(f'  Step flow: Ux_max={max(ux):.6f} Ux_min={min(ux):.6f}')
"
